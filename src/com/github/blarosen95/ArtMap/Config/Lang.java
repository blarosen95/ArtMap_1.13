...
import com.github.blarosen95.ArtMap.IO.Protocol.Out.WrappedPacket;
...
public enum Lang implements LangSet<String> {
    ...
    ADMIN_RECIPE, RECIPE_HELP, RECIPE_EASEL_NAME, RECIPE_CANVAS_NAME, RECIPE_PAINTBUCKET_NAME, RECIPE_ARTWORK_ARTIST,
